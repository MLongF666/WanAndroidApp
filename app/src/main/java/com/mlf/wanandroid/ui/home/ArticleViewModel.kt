    ...
    fun fetchBanners() {
        launch({
            handleRequest(ArticleRepository.getBannerList(), {
                ...
                Log.d("HomeArticleViewModel", "fetchBanners _bannerListStateFlow.value:${_bannerListStateFlow.value}")
            })
        })
    }
            ...
            CodeModel.TYPE_CODE_HOME->{
                launch({
                    handleRequest(ArticleRepository.getHomeArticleList(page), {
                        ...
                        Log.d("HomeArticleViewModel", "loadArticleList page:$page type:$type} article:${_articleListLiveData.value}")
                    })
                },{
