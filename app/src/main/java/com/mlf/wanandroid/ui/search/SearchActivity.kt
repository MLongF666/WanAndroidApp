...
import com.mlf.wanandroid.ui.adapter.SearchArticleAdapter
...
class SearchActivity : BaseActivity<ActivitySearchBinding, SearchViewModel>() {
	...
	private fun initSearchData() {
		getBinding().searchHotList.apply {
			searchHotListAdapter.setOnItemClickListener(object :SearchHotAdapter.OnItemClickListener{
				override fun onItemClick(position: Int, data: Hotkey) {
					data.name.showToast(this@SearchActivity)
				}
			})
		...
		getBinding().searchHistoryList.apply {
			...
			searchHistoryAdapter.apply {
				addChildClickViewIds(R.id.deleted)
				...
				setOnItemChildClickListener {
					...
					when(view.id){
						...
						R.id.cardLayout->{
							...
							laucherToWebActivity(this@SearchActivity,
